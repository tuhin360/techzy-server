...
// let cartCollection; // make sure you initialize this

// // Initialize collections
// const init = (db) => {
//   paymentCollection = db.collection("payments");
//   cartCollection = db.collection("carts"); // adjust to your cart collection name
// };
...
//   try {
//     const { email, transactionId, amount, date, cartItems, menuItems, status } = req.body;
...
const savePayment = async (req, res) => {
  try {
    const { email, transactionId, amount, date, cartItems, menuItems, status = "pending" } = req.body;
...
const getAllPayments = async (req, res) => {
  try {
    ...
    // Pretty console log for admin dashboard
...
const updatePaymentStatus = async (req, res) => {
  try {
    ...
    const updatedPayment = await paymentCollection.findOne({ _id: new ObjectId(id) });
...
const deletePayment = async (req, res) => {
  try {
    ...
    const paymentToDelete = await paymentCollection.findOne({ _id: new ObjectId(id) });
    ...
    console.log("🗑️  Payment deleted:");
    console.log("-----------------------------");
    console.log(`Payment ID : ${id}`);
    console.log(`Email      : ${paymentToDelete.email}`);
    console.log(`Status     : ${paymentToDelete.status}`);
    console.log(`Amount     : $${paymentToDelete.amount}`);
